...
planGoal: "After compaction, dokoro_session_recall still surfaces compacted content; no regression to token-reduction, recall behavior, or 824 tests; no infinite re-compaction loop. TDD, lint+build green."
